...
public class C06_indexOf {
    public static void main(String[] args) {
        ...
        System.out.println(str.indexOf("a")); // 9 ilk a'nın indexini döndurur
        ...
        System.out.println(str.indexOf("e",9));//13
         ...
         // 13.index deki e'den bir sonraki e'nin in dexini bulalım
        System.out.println(str.indexOf("e",14));// 16

        //cumledeki 2. c nin indeksini yazdırın

        int ilkcindex=str.indexOf("c"); //8

        System.out.println(str.indexOf("c",ilkcindex+1));//22

        System.out.println(str.indexOf("ali"));// -1 index olarak int döndurmesi bekleniyor
